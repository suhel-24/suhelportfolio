...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <section className="bg-white dark:bg-custom-blue">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="#" className="space-y-8" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-deepSeaGreen"
            >
              Send message
            </button>
          </form>
